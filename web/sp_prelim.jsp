                            ...
                            <div class="bg-white shadow-xs rounded-lg h-100 p-4 member-1">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-2"><div class="fw-700 font-xxl mb-3" style="margin-top: -15px;">Preliminary Observations</div>
                                        ...
                                        <button onclick="myFunction()" id="myButton" value="Submit" disabled>Submit</button><br /><br />
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px; ">
                                                ...
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <form action="#" name="dummy" >
                                                        <select id="state"name="state" style="width: 200px;" onchange="loadXMLDoc()" disabled>
                                            ...
                                            <div class="col-sm-12 mb-4"   >
                                                ...
                                                <div class="custom-control mr-0   custom-control-inline">
                                                   <form action="#" name="test" >
                                                    <select name="color" id="color" style="width: 200px;" onclick="loadDATA()" disabled>
                                            ...
                                            <div class="col-sm-12 mb-4"  >
                                                ...
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    ...
                                                    <select name="odour" id="odour" style="width: 200px;" onclick="loadOdour()" disabled>
