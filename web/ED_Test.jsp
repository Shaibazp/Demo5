                    ...
                    <div class="row">
                        <div class="col-lg-3 pr-md--2 margin">
                            <div class="bg-white shadow-xs rounded-lg h-81">
                                ...
                                <ul class="tab-ul">
                                    ...
                                    <li><a href="#" class="bg-white p-3 border-bottom-light w-100 fw-700 text-grey-700 font-xsss d-inline-block"><i class="ti-mobile font-md float-left mr-3"></i>Element Detection <i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
                        ...
                        <div class="col-lg-6 pl-md--2 pr-md--2 mt-sm--3" >
                            <div class="bg-white shadow-xs rounded-lg h-100 p-4 member-1">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-2"><div class="fw-700 font-xxl mb-3" style="margin-top: -15px;">Element Detection Test</div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px; ">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="nitrogen">Nitrogen Test:</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <form action="#" name="dummy" >
                                                        <select name="state" style="width: 200px;" onchange="loadXMLDoc()">
                                            ...
                                            <div class="col-sm-12 mb-4"   >
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="sulphur">Sulphur Test:</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                   <form action="#" name="test" >
                                                    <select name="color" id="color" style="width: 200px;" onclick="loadDATA()">
                                                            <option value="test">Select One</option>
                                                            <option value="Positive">Positive</option>
                                                            <option value="Negative">Negative</option>
                                            ...
                                            <div class="col-sm-12 mb-4"  >
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="halogen">Halogen/s Test:</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <form action="#" name="odrtest" >
                                                    <select name="odour" id="odour" style="width: 200px;" onclick="loadOdour()">
                                                        <option value="test">Select One</option>
                                                            <option value="Positive">Positive</option>
                                                            <option value="Negative">Negative</option>
                                            ...
                                            <div class="col-sm-12 mb-4"  >
                                                ...
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    ...
                                                    <select name="odour" id="odour" style="width: 200px;" onclick="loadOdour()">
                                                        <option value="test">Select One</option>
                                                            <option value="Chlorin">Chlorin</option>
