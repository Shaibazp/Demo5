                        ...
                        <div class="col-lg-3 pr-md--2 margin">
                            <div class="bg-white shadow-xs rounded-lg h-81">
                                ...
                                <ul class="tab-ul">
                                    ...
                                    <br><a href="#" class="d-block text-center bg-current border-0 w-100 form-bttn fw-500 rounded-lg text-white member-bttn2" style="margin-top: -18px;" >Chemical equation</a> 
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <iframe class="aboutPlayer" width="100%" height="400" src="qqq.mp4?autoplay=0&showinfo=0&controls=2&rel=0" frameborder="0"  ></iframe><!--https://www.youtube.com/embed/fju9ii8YsGs?autoplay=0&showinfo=0&controls=2&rel=0-->
                </div>
            </div>
        </div>
    </div>
