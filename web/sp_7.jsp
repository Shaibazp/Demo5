                ...
                xmlhttp.onreadystatechange = function ()
                {
                    if (xmlhttp.readyState == 4)
                    {
                        ...
                        else if(a=="meltingpoint")
                        {
                            ...
                            var image = new Image();
                            image.src = url;
                            document.getElementById('container1').appendChild(image);
                            
                            var url2 = 'resources/'+img2;
                            //alert(url2);
                        ...
                        <div class="col-lg-3 pr-md--2 margin">
                            <div class="bg-white shadow-xs rounded-lg h-81">
                                ...
                                <ul class="tab-ul">
                                    ...
                                    <li><a href="sp_5_Check.jsp" class="bg-white p-3 border-bottom-light w-100 fw-600 text-grey-500 font-xsss d-inline-block"><i class="ti-harddrives font-md float-left mr-3"></i> Functional Group Identify  <i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
                                    <li><a href="sp_6.jsp" class="bg-white p-3 border-bottom-light w-100 fw-600 text-grey-500 font-xsss d-inline-block"><i class="ti-game font-md float-left mr-3"></i> Derivative preparation  <i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
                                    <li><a href="#" class="bg-white p-3 border-bottom-light w-100 fw-600 text-grey-700 font-xsss d-inline-block"><i class="ti-dropbox font-md float-left mr-3"></i> Discussion  <i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
...
<!--                                    <br> <a href="#" class="d-block text-center bg-current border-0 w-100 form-bttn fw-500 rounded-lg text-white member-bttn2"  >Demonstration</a>  <br>
                        ...
                        <div class="col-lg-6 pl-md--2 pr-md--2 mt-sm--3" >
                            <div class="row">
                                <div class="col-sm-12 mb-2"><div class="fw-700 font-xxl mb-3" style="margin-top: -15px;">Discussion</div>

                                    <div class="col-sm-12" style="margin-top: -15px;"><textarea id="Instruction" name="Instruction" readonly rows="2" class="auto_height" oninput="auto_height(this)" style="width: 100%; margin-top: -5px;" > </textarea></div><br />
                                    <div class="col-sm-12" style="margin-top: -10px;"><textarea id="Rational" name="Rational" readonly rows="2" class="auto_height" oninput="auto_height(this)" style="width: 100%; margin-top: -5px;"> </textarea></div><br />
                                    <div class="col-sm-12" style="margin-top: -10px;"><textarea id="Procedure" name="Procedure" readonly rows="2" class="auto_height" oninput="auto_height(this)" style="width: 100%; margin-top: -5px;"> </textarea></div><br />
                                    ...
                                    <button id="start" onclick="loadXMLDoc(this.value);" value="start">Start</button>
                            ...
                            <div class="   text-center ">
                                <div class="card  border-0  d-block">
                                    ...
                                    <!--<div class="blog-page pt-7 pb-7 bg-white">-->
                                        <div class="container"  >
                                            <div class="row">
                                                
                                                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                                                    <article class="post-article p-0 border rounded-lg p-2">
                                                        <!--<img id="container" alt="blog-image" class="rounded-lg w-100" >-->
                                                        <p id="container1" alt="blog-image" class="rounded-lg w-100" ></p>
                            <!--                            <h6 class="font-xssss text-grey-500 fw-600 ml-3 mt-4 float-left"><i class="ti-time mr-2"></i> 24 May 2020</h6> 
                                                        <h6 class="font-xssss text-grey-500 fw-600 ml-3 mt-4 float-left"><i class="ti-user mr-2"></i> Jack Robin</h6>
                                                        <div class="clearfix"></div>
                                                        <h2 class="post-title mt-2 mb-2 pl-3 pr-3"><a href="#" class="lh-28 font-sm mont-font text-grey-800 fw-700">You work your way to creative thinking</a></h2>                                
                                                        <p class="font-xsss fw-400 text-grey-500 lh-26 mt-0 mb-2 pl-3 pr-3">Human coronaviruses are common and are typically associated with mild illnesses, similar to the common cold. We are digital agency.</p>
                                                        <a href="#" class="rounded-xl text-white bg-current w125 p-2 font-xsss ml-3 text-center fw-500 d-inline-block mb-3">Read More</a>-->
                                                    </article>
                                                </div>

                                                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                                                    <article class="post-article p-0 border rounded-lg p-2">
                                                        <p id="container2" alt="blog-image" class="rounded-lg w-100" ></p>
                            <!--                            <h6 class="font-xssss text-grey-500 fw-600 ml-3 mt-4 float-left"><i class="ti-time mr-2"></i> 24 May 2020</h6> 
                                                        <h6 class="font-xssss text-grey-500 fw-600 ml-3 mt-4 float-left"><i class="ti-user mr-2"></i> Jack Robin</h6>
                                                        <div class="clearfix"></div>
                                                        <h2 class="post-title mt-2 mb-2 pl-3 pr-3"><a href="#" class="lh-28 font-sm mont-font text-grey-800 fw-700">If you do it right, it will last ever forever</a></h2>                                
                                                        <p class="font-xsss fw-400 text-grey-500 lh-26 mt-0 mb-2 pl-3 pr-3">Human coronaviruses are common and are typically associated with mild illnesses, similar to the common cold. We are digital agency.</p>
                                                        <a href="#" class="rounded-xl text-white bg-current w125 p-2 font-xsss ml-3 text-center fw-500 d-inline-block mb-3">Read More</a>-->
                                                    </article>
                                                </div>  
