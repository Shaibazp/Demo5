...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function enable()
            {
                ...
                document.getElementById("Carbonyl").disabled = false;
                document.getElementById("myButton").style.visibility = 'visible';
                document.getElementById("submit").style.visibility='hidden';
                document.getElementById("Schiffs").style.visibility='hidden';
                document.getElementById("Tollens").style.visibility='hidden';
                document.getElementById("Fehlings").style.visibility='hidden';
                document.getElementById("Carboxylics").style.visibility='hidden';
                document.getElementById("Esters").style.visibility='hidden';
                document.getElementById("Alcohols").style.visibility='hidden';
                document.getElementById("Classifications").style.visibility='hidden';
                document.getElementById("Amines").style.visibility='hidden';
                document.getElementById("Riminis").style.visibility='hidden';
                document.getElementById("Simons").style.visibility='hidden';
            }
        </script>
        <script type="text/javascript">
            function enablebtn()
            {
                ...
                //alert(btn.value);
                if (btn.innerHTML == "Click for Schiff's Test")
                {
                    document.getElementById("Schiffss").disabled = false;
                }
                else if (btn.innerHTML == "Click for Tollens Test")
                {
                    document.getElementById("Tollen").disabled = false;
                }
                else if (btn.innerHTML == "Click for Fehling Test")
                {
                    document.getElementById("Fehling").disabled = false;
                }
                else if (btn.innerHTML == "Test For Carboxylic Acid")
                {
                    document.getElementById("Carboxylic").disabled = false;
                }
                else if (btn.innerHTML == "Test for Ester Group")
                {
                    document.getElementById("Ester").disabled = false;
                }
                else if (btn.innerHTML == "Test For Alcohol Group")
                {
                    document.getElementById("Alcohol").disabled = false;
                }
                else if (btn.innerHTML == "Test for Classfication")
                {
                ...
                else if (btn.innerHTML == "Test For Amine Group")
                {
                    document.getElementById("Amine").disabled = false;
                }
    ...
    <!----------------------Negative-------------------------------------->    
        <script>
            function Carboxylicss()
            {
                if (document.getElementById('Carboxylic').value == "Present")
                {
                    document.getElementById("Result").value ="Carboxylic Present";
                    document.getElementById("Inference").value = "The test compound is a carboxylic acid.";
                ...
                else if(document.getElementById('Carboxylic').value == "Absent")
                {
                    document.getElementById("Inference").value = "It should be tested for an ester.";
                    document.getElementById("myButton").value = "Test for Ester Group";
                    document.getElementById("myButton").innerHTML = "Test for Ester Group";
                    document.getElementById("myButton").style.visibility='visible';
                    document.getElementById("submit").style.visibility='hidden';
                    document.getElementById("Esters").style.visibility='visible';
                }
            }
        </script>
        <script>
            function Esterss()
            {
                if (document.getElementById('Ester').value == "Present")
                {
                    document.getElementById("Result").value ="Ester Present";
                    document.getElementById("Inference").value = "The test compound is an ester.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                    document.getElementById("Alcohols").style.visibility='hidden';  
                    document.getElementById("Classifications").style.visibility='hidden';
                ...
                else if(document.getElementById('Ester').value == "Absent")
                {
                    document.getElementById("Inference").value = "The test compound is not an ester.";
                    document.getElementById("myButton").value = "Test For Alcohol Group";
                    document.getElementById("myButton").innerHTML = "Test For Alcohol Group";
                    document.getElementById("myButton").style.visibility='visible';
                    document.getElementById("submit").style.visibility='hidden';
                    document.getElementById("Alcohols").style.visibility='visible';
                }
            }
        </script>
        <script>
            function Alcoholsss()
            {
                if (document.getElementById('Alcohol').value == "Present")
                {
                    document.getElementById("Inference").value = "The test compound is an ester.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                ...
                else if(document.getElementById('Alcohol').value == "Absent")
                {
                    document.getElementById("Inference").value = "The test compound is not an ester.";
                    document.getElementById("myButton").value = "Test For Alcohol Group";
                    document.getElementById("myButton").innerHTML = "Test For Alcohol Group";
        ...
        <script>
            function Classificationss()
            {
                if (document.getElementById('Classification').value == "Primary")
                {
                    document.getElementById("Result").value ="Primary Alcohol Present";
                    document.getElementById("Inference").value = "The test compound is primary alcohol.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                    document.getElementById("Amines").style.visibility='hidden';
                    document.getElementById("Riminis").style.visibility='hidden';
                ...
                else if(document.getElementById('Classification').value == "Secondary")
                {
                    document.getElementById("Result").value ="Secondary Alcohol Present";
                    document.getElementById("Inference").value = "The test compound is Secondary alcohol.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                    document.getElementById("Amines").style.visibility='hidden';
                    document.getElementById("Riminis").style.visibility='hidden';
        ...
        <script>
            function Aminess()
            {
                if (document.getElementById('Amine').value == "Primary")
                {
                    document.getElementById("Result").value ="Primary Amine Present";
                    document.getElementById("Inference").value = "Do the Rimini's Test.";
                ...
                else if(document.getElementById('Amine').value == "Secondary")
                {
                    ...
                    document.getElementById("myButton").style.visibility='visible';
                    document.getElementById("submit").style.visibility='hidden';
                    document.getElementById("Simons").style.visibility='visible';
                }
                else if(document.getElementById('Amine').value == "Tertiary")
                {
        ...
        <script>
            function Riminiss()
            {
                if (document.getElementById('Rimini').value == "Present")
                {
                    document.getElementById("Inference").value = "The test compound is a primary amine.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                }
                else if(document.getElementById('Rimini').value == "Absent")
                {
        ...
        <script>
            function Simonss()
            {
                if (document.getElementById('Simon').value == "Present")
                {
                    document.getElementById("Inference").value = "The test compound is a secondary amine.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                }
                else if(document.getElementById('Simon').value == "Absent")
                {
   ...
   <script>
            function Phenolss()
            {
                if (document.getElementById('Phenol').value == "Present")
                {
                    document.getElementById("Result").value ="Phenol Present";
                    document.getElementById("Inference").value = "The test compound is a phenol.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                    
                }
                else if(document.getElementById('Phenol').value == "Absent")
                {
                    document.getElementById("Inference").value = "The compound requires another test. Please refer relevant literature.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                }
            }
        ...
        <script>
            function Fehlingss()
            {
                if (document.getElementById('Fehling').value == "Present")
                {
                    document.getElementById("Result").value ="Aldehyde Present";
                    document.getElementById("Inference").value = "The test compound is an aldehyde.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                    
                }
                else if(document.getElementById('Fehling').value == "Absent")
                {
                    document.getElementById("Result").value ="Ketone Present";
                    document.getElementById("Inference").value = "The test compound is a ketone.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                }
            }
        ...
        <script>
            function Tollenss()
            {
                if (document.getElementById('Tollen').value == "Present")
                {
                    document.getElementById("Inference").value = "The test compound is an aldehyde.";
                    document.getElementById("myButton").value = "Click for Fehling Test";
                    document.getElementById("myButton").innerHTML = "Click for Fehling Test";
                    
                }
                else if(document.getElementById('Tollen').value == "Absent")
                {
                    document.getElementById("Inference").value = "The test compound is a ketone.";
                    document.getElementById("myButton").value = "Click for Fehling Test";
                    document.getElementById("myButton").innerHTML = "Click for Fehling Test";
        ...
        <script>
            function Inferences()
            {
                if (document.getElementById('Schiffss').value == "Present")
                {
                    document.getElementById("Inference").value = "The test compound is an aldehyde.";
                    document.getElementById("myButton").value = "Click for Tollens Test";
                    document.getElementById("myButton").innerHTML = "Click for Tollens Test";
                }
                else if(document.getElementById('Schiffss').value == "Absent")
                {
                    document.getElementById("Inference").value = "The test compound is a ketone.";
                    document.getElementById("myButton").value = "Click for Tollens Test";
                    document.getElementById("myButton").innerHTML = "Click for Tollens Test";
        ...
        <script>
            function Carbonyl1()
            {
                if (document.getElementById('Carbonyl').value == "Present")
                {
                    document.getElementById('Schiffs').style.visibility = 'visible';
                    document.getElementById('Tollens').style.visibility = 'visible';
                    document.getElementById('Fehlings').style.visibility = 'visible';
                    document.getElementById('Carboxylics').style.visibility = 'hidden';
                    document.getElementById("myButton").value = "Click for Schiff's Test";
                    document.getElementById("myButton").innerHTML = "Click for Schiff's Test";
                    document.getElementById("Inference").value = "The compound contains carbonyl  group and should be differentiated into an aldehyde or a ketone.";
                    document.getElementById("Esters").style.visibility='hidden';
                    document.getElementById("Alcohols").style.visibility='hidden';
                    document.getElementById("Classifications").style.visibility='hidden';
                    document.getElementById("Amines").style.visibility='hidden';
                ...
                else if(document.getElementById('Carbonyl').value == "Absent")
                {
                    document.getElementById('Carboxylics').style.visibility = 'visible';
                    document.getElementById('Schiffs').style.visibility = 'hidden';
                    document.getElementById('Tollens').style.visibility = 'hidden';
                    document.getElementById('Fehlings').style.visibility = 'hidden';
                    document.getElementById("myButton").value = "Test For Carboxylic Acid";
                    document.getElementById("myButton").innerHTML = "Test For Carboxylic Acid";
                    document.getElementById("Inference").value = "The test compound does not contain carbonyl group.";
                    document.getElementById("myButton").style.visibility='visible';
                    document.getElementById("submit").style.visibility='hidden';
                }
            }
            ...
            function loadXMLDoc(str)
            {
                ...
                xmlhttp.onreadystatechange = function ()
                {
                    if (xmlhttp.readyState == 4)
                    {
                        ...
                        var q = some.getElementsByTagName("Result")[0].childNodes[0].nodeValue;
                        if(q=="phenol")
                        {
                            document.getElementById("Phenols").style.visibility='visible';
                            document.getElementById("Carbonyls").style.visibility='hidden';
                            document.getElementById("myButton").style.visibility='hidden';
                        }
                        else if(q=="carbonyl")
                        {
                            document.getElementById("Phenols").style.visibility='hidden';
            ...
            function Alcoholss(str)
            {
                ...
                xmlhttp.onreadystatechange = function ()
                {
                    if (xmlhttp.readyState == 4)
                    {
                        ...
                        else if(a=="Test for Classfication")
                        {
                            document.getElementById("myButton").value = "Test for Classfication";
                            document.getElementById("myButton").innerHTML = "Test for Classfication";
                        ...
                        else if(a=="Test For Amine Group")
                        {
                            document.getElementById("myButton").value = "Test For Amine Group";
                            document.getElementById("myButton").innerHTML = "Test For Amine Group";
                            document.getElementById("Classifications").style.visibility='hidden';
                            document.getElementById("Amines").style.visibility='visible';
                            document.getElementById("Riminis").style.visibility='hidden';
                            document.getElementById("Simons").style.visibility='hidden';
                            document.getElementById("myButton").style.visibility='visible';
                            document.getElementById("submit").style.visibility='hidden';
                ...
                <div class="container" style="margin-left: 1px;">
                    <div class="row">
                        <div class="col-lg-3 pr-md--2 margin">
                            <div class="bg-white shadow-xs rounded-lg h-81">
                                ...
                                <ul class="tab-ul">
                                    ...
                                    <li><a href="sp.jsp" class="bg-white p-3 border-bottom-light w-100 fw-700 text-grey-500 font-xsss d-inline-block"><i class="ti-mobile font-md float-left mr-3"></i>Preliminary Observations<i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
                                    <li><a href="sp_2.jsp" class="bg-white p-3 border-bottom-light w-100 fw-700 text-grey-500 font-xsss d-inline-block"><i class="ti-mobile font-md float-left mr-3"></i>Broad Classification<i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
                                    <li><a href="sp_3.jsp" class="bg-white p-3 border-bottom-light w-100 fw-600 text-grey-500 font-xsss d-inline-block"><i class="ti-pie-chart font-md float-left mr-3"></i> Element Detection <i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
                                    <li><a href="sp_4.jsp" class="bg-white p-3 border-bottom-light w-100 fw-600 text-grey-500 font-xsss d-inline-block"><i class="ti-stats-up font-md float-left mr-3"></i> Solubility Tests  <i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
                                    <li><a href="#" class="bg-white p-3 border-bottom-light w-100 fw-600 text-grey-700 font-xsss d-inline-block"><i class="ti-harddrives font-md float-left mr-3"></i> Functional Group Identify  <i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
                        ...
                        <div class="col-lg-6 pl-md--2 pr-md--2 mt-sm--3" >
                            <div class="row">
                                <div class="col-sm-12 mb-2"><div class="fw-700 font-xxl mb-3" style="margin-top: -15px;">Functional Group Identify</div>
                                    ...
                                    <form action="result_5_1.jsp" methos="POST">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Phenols">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carbonyl">Phenol :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Phenol" name="Phenol" style="width: 200px;" onchange="Phenolss();" >
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Carbonyls">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carbonyl">Carbonyl Group :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Carbonyl" name="Carbonyl" style="width: 200px;" onchange="Carbonyl1();" >
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Schiffs">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Schiffs Test :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Schiffss" name="Schiffs" style="width: 200px;" onchange="Inferences();" disabled>
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden " id="Tollens">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Tollen's Test :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Tollen" name="Tollen" style="width: 200px;" onchange="Tollenss();" disabled>
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden " id="Fehlings">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Fehling's Test :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Fehling" name="Fehling" style="width: 200px;" onchange="Fehlingss();" disabled>
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden " id="Carboxylics">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Carboxylic Acid :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Carboxylic" name="Carboxylic" style="width: 200px;" onchange="Carboxylicss();" disabled>
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden " id="Esters">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Ester :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Ester" name="Ester" style="width: 200px;" onchange="Esterss();" disabled>
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden " id="Alcohols">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Alcohol :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Alcohol" name="Alcohol" style="width: 200px;" onchange="Alcoholss(this.value);" disabled>
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden " id="Classifications">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Classification :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Classification" name="Classification" style="width: 200px;"  onchange="Classificationss();" disabled>
                                                        <option>Select</option>  
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden " id="Amines">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Amine Group :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Amine" name="Amine" style="width: 200px;"  onchange="Aminess();" disabled>
                                                        <option>Select</option>  
                                                        <option value="Primary">Primary</option>
                                                        <option value="Secondary">Secondary</option>
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Riminis">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Rimini's Test :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Simons">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Simon's Test :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Simon" name="Simon" style="width: 200px;"  onchange="Simonss();" disabled>
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
