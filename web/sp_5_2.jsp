...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function enable()
            {
                ...
                document.getElementById("Polyhydrics").style.visibility='hidden';
                document.getElementById("Carbonyls").style.visibility='hidden';
                document.getElementById("Schiffs").style.visibility='hidden';
                document.getElementById("Tollenss").style.visibility='hidden';
        ...
        <script type="text/javascript">
            function enablebtn()
            {
                ...
                //alert(btn.value);
                if (btn.innerHTML == "Test for Polyhydric Alcohol")
                {
                    document.getElementById("Polyhydric").disabled = false;
                }
                else if (btn.innerHTML == "Test for Carbonyl group")
                {
                    document.getElementById("Carbonyl").disabled = false;
                }
                else if (btn.innerHTML == "Click for Schiff's Test")
                {
                    document.getElementById("Schiff").disabled = false;
                }
                else if (btn.innerHTML == "Click for Tollens Test")
                {
                    document.getElementById("Tollens").disabled = false;
                }
    ...
    <script>
            function Polyhydricss()
            {
                if (document.getElementById('Polyhydric').value == "Present")
                {
                    document.getElementById("Result").value ="Poly Alcohol Present";
                    document.getElementById("Inference").value = "The test compound is a polyhydric alcohol. Proceed to test the presence of a carbonyl group.";
                    document.getElementById("myButton").value = "Test for Carbonyl group";
                    document.getElementById("myButton").innerHTML = "Test for Carbonyl group";
                ...
                else if(document.getElementById('Polyhydric').value == "Absent")
                {
                    document.getElementById("Inference").value = "The test compound is not polyhydric alcohol. Proceed to test the presence of a carbonyl group.";
                    document.getElementById("myButton").value = "Test for Carbonyl group";
                    document.getElementById("myButton").innerHTML = "Test for Carbonyl group";
                    document.getElementById("Carbonyls").style.visibility='visible';
                    document.getElementById("submit").style.visibility='hidden';
    ...
    <script>
            function Schiffss()
            {
                if (document.getElementById('Schiff').value == "Present")
                {
                    ...
                    document.getElementById("Tollenss").style.visibility='visible';
                }
        ...
        <script>
            function Tollensss()
            {
                if (document.getElementById('Tollens').value == "Present")
                {
                    document.getElementById("Inference").value = "The test compound is an aldehyde.";
                ...
                else if(document.getElementById('Tollens').value == "Absent")
                {
                    document.getElementById("Inference").value = "The test compound is a ketone.";
                    document.getElementById("myButton").value = "Click for Fehling Test";
                    document.getElementById("myButton").innerHTML = "Click for Fehling Test";
        ...
        <script>
            function Amidess()
            {
                if (document.getElementById('Amide').value == "Present")
                {
                    ...
                    document.getElementById("Inference").value = "The test compound is an aliphatic amide.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                }
                ...
                {
                    document.getElementById("Result").value ="Ketone Present";
                    document.getElementById("Inference").value = "The test compound is not an aliphatic amide.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                }
            }
    ...
    <!---------------POSITIVE--------------------------------------------->
        <script>
            function Carboxylicss()
            {
                ...
                {
                    document.getElementById("Inference").value = "The test compound is not a carboxylic acid. It should be subjected to a test for polyhydric alcohol.";
                    document.getElementById("myButton").value = "Test for Polyhydric Alcohol";
                    document.getElementById("myButton").innerHTML = "Test for Polyhydric Alcohol";
                    document.getElementById("myButton").style.visibility='visible';
                    document.getElementById("submit").style.visibility='hidden';
                    document.getElementById("Polyhydrics").style.visibility='visible';
                    document.getElementById("Schiffs").style.visibility='hidden';
                    document.getElementById("Tollenss").style.visibility='hidden';
                    document.getElementById("Felhings").style.visibility='hidden';
                    document.getElementById("Amides").style.visibility='hidden';
            ...
            function Carbonylss(str)
            {
                ...
                xmlhttp.onreadystatechange = function ()
                {
                    if (xmlhttp.readyState == 4)
                    {
                        ...
                        else if(a=="Test for Amide group")
                        {
                            var aa= some.getElementsByTagName("State")[0].childNodes[0].nodeValue;
                            document.getElementById("myFrame").src = aa;
                            document.getElementById("Inference").value = some.getElementsByTagName("Inference")[0].childNodes[0].nodeValue;
                        ...
                        <div class="col-lg-6 pl-md--2 pr-md--2 mt-sm--3" >
                            <div class="row">
                                <div class="col-sm-12 mb-2"><div class="fw-700 font-xxl mb-3" style="margin-top: -15px;">Functional Group Identify</div>
                                    ...
                                    <form action="result_5_2.jsp" methos="POST">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Carboxylics">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carboxylic">Carboxylic Acid :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Carboxylic" name="Carboxylic" style="width: 200px;" onchange="Carboxylicss();" >
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Polyhydrics">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carbonyl">Polyhydric Alcohol :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Polyhydric" name="Polyhydric" style="width: 200px;" onchange="Polyhydricss();" disabled >
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Carbonyls">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Carbonyl Group :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Carbonyl" name="Carbonyl" style="width: 200px;" onchange="Carbonylss(this.value);" disabled>
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden " id="Schiffs">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Schiff's Test :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden " id="Tollenss">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Tollens's Test :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Tollens" name="Tollens" style="width: 200px;" onchange="Tollensss();" disabled>
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden " id="Felhings">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Felhing's Test :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden " id="Amides">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="state">Amide Group :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
