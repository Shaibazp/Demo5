            ...
            function loadXMLDoc()
            {
                ...
                xmlhttp.onreadystatechange = function ()
                {
                    if (xmlhttp.readyState == 4)
                    {
                        ...
                        document.getElementById("State").value = some.getElementsByTagName("state")[0].childNodes[0].nodeValue;
                        document.getElementById("Classs").value = some.getElementsByTagName("AliAro")[0].childNodes[0].nodeValue;
                        document.getElementById("Physical").value = some.getElementsByTagName("boiling")[0].childNodes[0].nodeValue;
                        document.getElementById("Element").value = some.getElementsByTagName("element")[0].childNodes[0].nodeValue;
                        document.getElementById("Solubility").value = some.getElementsByTagName("functional")[0].childNodes[0].nodeValue;
                        document.getElementById("Functional").value = some.getElementsByTagName("result")[0].childNodes[0].nodeValue;
                        document.getElementById("Derivative").value = some.getElementsByTagName("mpoint")[0].childNodes[0].nodeValue;
                    }
                }
                    ...
                    <div class="row">
                        <div class="col-lg-3 pr-md--2 margin">
                            <div class="bg-white shadow-xs rounded-lg h-81">
                                ...
                                <ul class="tab-ul">
                                    <li><a href="#" class="bg-white p-3 border-bottom-light w-100 fw-600 text-grey-500 font-xsss d-inline-block"><i class="ti-mobile font-md float-left mr-3"></i>Preliminary Observations<i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
                                    <li><a href="#" class="bg-white p-3 border-bottom-light w-100 fw-600 text-grey-500 font-xsss d-inline-block"><i class="ti-mobile font-md float-left mr-3"></i>Broad Classification<i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
                                    ...
                                    <li><a href="#" class="bg-white p-3 border-bottom-light w-100 fw-600 text-grey-700 font-xsss d-inline-block"><i class="ti-credit-card font-md float-left mr-3"></i> Result <i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 pl-md--2 pr-md--2 mt-sm--3" >
                            <div class="row" >
                                <div class="col-sm-12 mb-2" ><div class="fw-700 font-xxl1  mb-3" style="margin-top: -15px;">Experiment No.  ..........<br>To Identify the Given Organic Compound, Sample no. ............. </div>
                                    <div class="col-sm-12" style="margin-top: -10px;">State     <textarea id="State" name="Instruction" rows="1"   class="auto_height"   oninput="auto_height(this)" name="instuction"    style="width: 100%; margin-top: -5px;" > </textarea></div> 
                                    <div class="col-sm-12" style="margin-top: -10px;">Class<textarea id="Classs" name="Rational" readonly rows="1" class="auto_height" oninput="auto_height(this)" style="width: 100%; margin-top: -5px;"> </textarea></div>
                                    <div class="col-sm-12" style="margin-top: -10px;">Physical Constant<textarea id="Physical" name="Observation" readonly rows="1" class="auto_height" oninput="auto_height(this)" style="width: 100%; margin-top: -5px;"> </textarea></div>
                                    <div class="col-sm-12" style="margin-top: -10px;">Element Present<textarea id="Element" name="Reagent" readonly rows="1" class="auto_height" oninput="auto_height(this)" style="width: 100%; margin-top: -1px;"> </textarea></div>
                                    <div class="col-sm-12" style="margin-top: -10px;">Solubility<textarea id="Solubility" name="Inference" readonly rows="1" class="auto_height" oninput="auto_height(this)"  style="width: 100%;  margin-top: -1px;"> </textarea></div>
                                    <div class="col-sm-12" style="margin-top: -10px;">Functional group identified<textarea id="Functional" name="Reagent" readonly rows="1" class="auto_height" oninput="auto_height(this)" style="width: 100%; margin-top: -1px;"> </textarea></div>
                                    <div class="col-sm-12" style="margin-top: -10px;">Name of Derivative & it's Melting Point<textarea id="Derivative" name="Inference" readonly rows="1" class="auto_height" oninput="auto_height(this)"  style="width: 100%;  margin-top: -1px;"> </textarea></div>
                                    <div class="col-sm-12" style="margin-top: -10px;">Test compound<textarea name="Inference" readonly rows="8" class="auto_height" oninput="auto_height(this)"  style="width: 100%;  color: red; margin-top: -1px;"> </textarea></div>
                                    <div class="col-sm-12" style="margin-top: -10px;">Corresponding Derivative<textarea name="Corresponding" readonly rows="8" class="auto_height" oninput="auto_height(this)"  style="width: 100%;  color: red; margin-top: -1px;"> </textarea></div>
                                    <br>
                                    <div class="col-sm-6">
                                        
                                    </div>
                                    
                                    <!--                                        <button id="start" onclick="start();enable();hide();">Generate Result</button>
                                                                            <button id="start">Print Result</button>-->
                                </div>
                                <button id="start" onclick="loadXMLDoc();">Generate Result</button>
                                  <script LANGUAGE="JavaScript">
                    if(window.print)
                    {
                        window.focus();
                        document.write('<form><input type=submit name=print value="Print Result" onClick="window.print();"></form>')
                    }
                </script>
                    ...
                    input[type=submit]
                    {
                        ...
                        <div class="member-2" style="display: none;">
                            ...
                            <div class="card bg-white shadow-xs border-0">
                                <div class="card-body d-flex justify-content-between align-items-end p-4">s
                                    <div>
                                        <h4 class="text-grey-700 mb-0 d-flex align-items-center justify-content-between mt-0 fw-600 lato-font font-xsss">
