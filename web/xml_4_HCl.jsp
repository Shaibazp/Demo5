...
//          System.out.println("Mobile No : "+mobile1);
            ...
            while (rst.next()) 
            {
                ...
                if (sn.equals("Yes")) 
                {
                    ...
                    {
                        out.println("<Inference>The compound can be tested for the presence of amine and hydrazine during Functional Group Identification.</Inference>");
                ...
                {
                    out.println("<Inference>The compound cannot be tested for the presence of amine and hydrazine during Functional Group Identification.</Inference>");
                }
                out.println("</emp>");
