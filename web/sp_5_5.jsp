    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function enable()
            {
                ...
                document.getElementById("Felhings").style.visibility='hidden';
                ...
                document.getElementById("Aryl-Alkyls").style.visibility='hidden';
        ...
        <script type="text/javascript">
            function enablebtn()
            {
                ...
                {
                    document.getElementById("Felhing").disabled = false;
                }
                ...
                else if (btn.innerHTML == "Aryl-Alkyl Hydro Test")
                {
                    document.getElementById("Aryl-Alkyl").disabled = false;
                }
            }
        </script>
        <!--===============================================================-->
        ...
        <script type="text/javascript">
            function Alcoholss()
            {
                ...
                {
                    document.getElementById("Inference").value ="The alcohol should be subjected to differentiation test for confirming whether primary or secondary nature of alcohol.";
                ...
                {
                    document.getElementById("Inference").value = "The test compound is not an alcohol.";
                    document.getElementById("myButton").value = "Click for Ether Test";
        ...
        <script>
            function bname()
            {
                if(document.getElementById("myButton").value == "Click for Ether Test")
                {
                    document.getElementById("myButton").value = "Aryl-Alkyl Hydro Test";
                    document.getElementById("myButton").innerHTML = "Aryl-Alkyl Hydro Test";
                    document.getElementById("Aryl-Alkyls").style.visibility='visible';
                    document.getElementById("myButton").style.visibility='visible';
                    document.getElementById("submit").style.visibility='hidden';
                }
            }
        ...
        <script type="text/javascript">
            function Aryl_Alkylss()
            {
                if(document.getElementById('Aryl-Alkyl').value == "Present")
                {
                    document.getElementById("Result").value ="Aryl_Alky Hydro Present";
                    document.getElementById("Inference").value ="The test compound is an Aryl-Alkyl Hydrocarbons.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                }
                else if(document.getElementById('Aryl-Alkyl').value == "Absent")
                {
                    document.getElementById("Inference").value = "The test compound is not an Aryl-Alkyl Hydrocarbons.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                }
            }
        ...
        <script type="text/javascript">
            function Hydrocarbonsss()
            {
                if(document.getElementById('Hydrocarbons').value == "Present")
                {
                    document.getElementById("Result").value ="Hydrocarbons Present";
                    document.getElementById("Inference").value ="The test compound is a Hydrocarbons.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                }
                else if(document.getElementById('Hydrocarbons').value == "Absent")
                {
                    document.getElementById("Inference").value = "The test compound is not a Hydrocarbons.";
                    document.getElementById("myButton").style.visibility='hidden';
                    document.getElementById("submit").style.visibility='visible';
                }
            }
        ...
        <script type="text/javascript">
            function Carbonylss()
            {
                if(document.getElementById('Carbonyl').value == "Present")
                {
                    ...
                    document.getElementById("Felhings").style.visibility='visible';
                    document.getElementById("myButton").style.visibility='visible';
                    document.getElementById("submit").style.visibility='hidden';
                    document.getElementById("Esters").style.visibility='hidden';
                    document.getElementById("Alcohols").style.visibility='hidden';
        ...
        <script type="text/javascript">
            function Schiffss()
            {
                if(document.getElementById('Schiff').value == "Present")
                {
                ...
                else if(document.getElementById('Schiff').value == "Absent")
                {
        ...
        <script type="text/javascript">
            function Felhingss()
            {
                if(document.getElementById('Felhing').value == "Present")
                {
                ...
                else if(document.getElementById('Felhing').value == "Absent")
                {
            ...
            function loadXMLDoc(str)
            {
                ...
                xmlhttp.onreadystatechange = function ()
                {
                    if (xmlhttp.readyState == 4)
                    {
                        ...
                        else if(a=="hydrocarbons_combo")
                        {
                            document.getElementById("Hydrocarbonss").style.visibility = 'visible';
                        }
                    }
                }
                        ...
                        <div class="col-lg-6 pl-md--2 pr-md--2 mt-sm--3" >
                            <div class="row">
                                <div class="col-sm-12 mb-2"><div class="fw-700 font-xxl mb-3" style="margin-top: -15px;">Functional Group Identify</div>
                                    ...
                                    <button onclick="loadXMLDoc(this.value);enablebtn();bname();" id="myButton" value="submit" disabled>Submit</button><br /><br />

                                    <form action="result_5_5.jsp" methos="POST">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Hydrocarbonss">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carbonyl">Hydrocarbons :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Hydrocarbons" name="Hydrocarbons" style="width: 200px;" onchange="Hydrocarbonsss();"  >
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Carbonyls">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carboxylic">Carbonyl Group :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Carbonyl" name="Carbonyl" style="width: 200px;" onchange="Carbonylss();" >
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Schiffs">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carbonyl">Schiff's Test :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Schiff" name="Schiff" style="width: 200px;" onchange="Schiffss();" disabled>
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Tollens">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carbonyl">Tollen's Test :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Felhings">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carbonyl">Felhing's Test :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Felhing" name="Felhing" style="width: 200px;" onchange="Felhingss();" disabled >
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Esters">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carbonyl">Ester :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Alcohols">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carbonyl">Alcohol :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Alcohol" name="Alcohol" style="width: 200px;" onchange="Alcoholss();" disabled >
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Classifications">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carbonyl">Classification :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                            ...
                                            <!--combobox for Classification-->  
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Aryl-Alkyls">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carbonyl">Aryl-Alkyl Hydro :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Aryl-Alkyl" name="Aryl-Alkyl" style="width: 200px;" onchange="Aryl_Alkylss();" disabled >
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
