        ...
        <script type="text/javascript">
            function myFunction()
            {
                ...
                } else if (btn.value == "Melting Point")
                {
                    ...
                    //btn.value = "mm";
                    btn.innerHTML = "Melting Point";
                    document.getElementById("myFrame").src = "https://www.youtube-nocookie.com/embed/keZc1MyZPzA";//"https://wwf.org";//"melting.mp4";//
                ...
                } else if (btn.value == "Boiling Point")
                {
                    ...
                    document.getElementById("myFrame").src = "boiling.mp4";
                    //btn.value = "BP";
                        ...
                        <div class="col-lg-3 pr-md--2 margin">
                            <div class="bg-white shadow-xs rounded-lg h-81">
                                ...
                                <ul class="tab-ul">
                                    ...
                                    <li><a href="#" class="bg-white p-3 border-bottom-light w-100 fw-700 text-grey-500 font-xsss d-inline-block"><i class="ti-mobile font-md float-left mr-3"></i>Broad Classification<i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
                            ...
                            <div class="row">
                                <div class="col-sm-12 mb-2"><div class="fw-700 font-xxl mb-3" style="margin-top: -15px;">Preliminary Observations</div>
                                    ...
                                    <button onclick="myFunction();
                                                loadXMLDoc(this.value);" id="myButton" value="Submit1" disabled>Submit</button><br /><br />
