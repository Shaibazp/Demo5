    ...
    <head>
        ...
        <script type="text/javascript">
            function enablebtn()
            {
                ...
                //alert(btn.value);
                if (btn.innerHTML == "Test For Phenol Group")
                {
                    document.getElementById("Phenol").disabled = false;
                }
                ...
                xmlhttp.onreadystatechange = function ()
                {
                    if (xmlhttp.readyState == 4)
                    {
                        ...
                        else if(a=="cc")
                        {
                            ...
                            document.getElementById("myButton").value = "Test for Phenol group";
                            document.getElementById("myButton").innerHTML = "Test For Phenol Group";
                        ...
                        <div class="col-lg-6 pl-md--2 pr-md--2 mt-sm--3" >
                            <div class="row">
                                <div class="col-sm-12 mb-2"><div class="fw-700 font-xxl mb-3" style="margin-top: -15px;">Functional Group Identify</div>
                                    ...
                                    <form action="result_5_3.jsp" methos="POST">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Carboxylics">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carboxylic">Carboxylic Acid Group :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Carboxylic" name="Carboxylic" style="width: 200px;" onchange="Carboxylicss(this.value);" >
                                            ...
                                            <div class="col-sm-12 mb-4"  style="margin-top:20px;visibility: hidden; " id="Phenols">
                                                <div class="custom-control mr-4   custom-control-inline">
                                                    <label for="Carbonyl">Phenol Group :</label>
                                                </div>
                                                <div class="custom-control mr-0   custom-control-inline">
                                                    <select id="Phenol" name="Phenol" style="width: 200px;" onchange="Phenolss();" disabled >
                                                        <option>Select</option>  
                                                        <option value="Present">Present</option>
                                                        <option value="Absent">Absent</option>
                                                    </select>   
