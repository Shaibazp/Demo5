            ...
            function loadXMLDoc(str)
            {
                ...
                xmlhttp.onreadystatechange = function ()
                {
                    if (xmlhttp.readyState == 4)
                    {
                        ...
                        document.getElementById("Result").value = some.getElementsByTagName("Ennable")[0].childNodes[0].nodeValue;
                    }
                }
                        ...
                        <div class="col-lg-3 pr-md--2 margin">
                            <div class="bg-white shadow-xs rounded-lg h-81">
                                ...
                                <ul class="tab-ul">
                                    ...
                                    <li><a href="#" class="bg-white p-3 border-bottom-light w-100 fw-600 text-grey-700 font-xsss d-inline-block" ><i class="ti-game font-md float-left mr-3"></i> Derivative preparation  <i class="ti-angle-right float-right text-grey-400 mt-1"></i></a></li>
...
<!--                                    <br> <a href="#" class="d-block text-center bg-current border-0 w-100 form-bttn fw-500 rounded-lg text-white member-bttn2"  >Demonstration</a>  <br>
                        ...
                        <div class="col-lg-6 pl-md--2 pr-md--2 mt-sm--3" >
                            <div class="row">
                                <div class="col-sm-12 mb-2"><div class="fw-700 font-xxl mb-3" style="margin-top: -15px;">Derivative preparation</div>
                                    ...
                                    <form action="result_6.jsp" methos="POST">
