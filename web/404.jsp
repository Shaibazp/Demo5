                        ...
                        <div class="col-lg-6 pl-md--2 pr-md--2 mt-sm--3" >
                            ...
                            <div class="   text-center ">
                                <div class="card  border-0  d-block">
                                    ...
                                    <h1 class="fw-700 text-grey-900 display4-size">Oops! Invalid</h1>
                                    <p class="text-grey-500 font-xss">It seems that the investigation has gone wrong somewhere. Repeat the identification from start.</p>
                                    <a href="sp.jsp" class="p-3 w175 bg-current text-white d-inline-block text-center fw-600 font-xssss rounded-lg text-uppercase ls-3">Home Page</a>
                                </div>
                            </div>
                        </div>
